...
<%@ page import="com.model.contectmodel" %>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 content">
        ...
        <h2>Welcome to the Admin Panel</h2>
         ...
         List<contectmodel>list = Dao.contectviewdata();
         
         for(contectmodel cm : list)
         {
         ...
         %>
                ...
                <td><%= cm.getFullname()%></td><td><%= cm.getEmail() %></td><td><%= cm.getQuery() %></td>
